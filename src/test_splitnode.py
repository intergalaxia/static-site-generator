...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_links(self):
        matches = extract_markdown_links("To [google](https://www.google.com) and [youtube](https://www.youtube.com)")
        self.assertListEqual([("google", "https://www.google.com"), ("youtube", "https://www.youtube.com")], matches)

    def test_extract_markdown_links_without_full_url(self):
        matches = extract_markdown_links("To [google](google.com) and [youtube](youtube.com)")
        self.assertListEqual([("google", "google.com"), ("youtube", "youtube.com")], matches)
